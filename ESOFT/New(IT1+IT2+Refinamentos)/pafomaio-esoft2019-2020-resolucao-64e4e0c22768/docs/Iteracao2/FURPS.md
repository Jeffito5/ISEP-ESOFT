...
configurabilidade, instalabilidade, escalabilidade entre outros.*
  ...
  *     **As palavras-passe de todos os utilizadores do sistema devem: ser geraas pela plataforma recorrendo a um algoritmo externo (i.e. concebido por terceiros) e configurado apenas aquando da implantação do sistema.**
